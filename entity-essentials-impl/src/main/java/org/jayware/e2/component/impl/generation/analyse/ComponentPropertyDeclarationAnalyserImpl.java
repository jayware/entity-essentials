...
public class ComponentPropertyDeclarationAnalyserImpl
implements ComponentPropertyDeclarationAnalyser
{
    private final ComponentPropertyDescriptorBuilder myBuilder = new ComponentPropertyDescriptorBuilderImpl();

    @Override
    public ComponentPropertyDescriptor analyse(Field field)
    {
