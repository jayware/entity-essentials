...
public interface GroupManager
{
     ...
     */
    Group createGroup(Context context);
     ...
     * @throws IllegalStateException if the specified {@link Context} is disposed.
     */
    Group createGroup(Context context, String name);
     ...
     */
    Group getGroup(Context context, String name);

    /**
     * Returns the {@link Group} with the given name in the specified {@link Context}.
     * <p>
     * <b>Note:</b> In contrast to {@link GroupManager#getGroup(Context, String)}
     ...
     * @throws IllegalStateException if the passed Context is disposed.
     */
    Group findGroup(Context context, String name);

    /**
     * Returns all {@link Group Groups} within the specified {@link Context}.
     *
     ...
     */
    List<Group> findGroups(Context context);
    ...
    /**
     * Returns a new instance of a {@link ContextualGroupManager} which belongs to the specified {@link Context}.
     *
     * @param context a {@link Context}
     *
     * @return a {@link ContextualGroupManager}.
     *
     * @throws IllegalArgumentException if the passed {@link Context} is <code>null</code>.
     * @throws IllegalStateException if the passed {@link Context} has been disposed.
     */
    ContextualGroupManager asContextual(Context context);
}
